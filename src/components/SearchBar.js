...
const Option = AutoComplete.Option; //autocolete only accepts array of string or Option component
...
export class SearchBar extends React.Component {
    ...
    render() {
        ...
        return (
          //size = "large" -> make the input block larger
            <AutoComplete
            ...
            >
                <Input suffix={<Icon type="search" className="certain-category-icon" />} /> //magnifier
            </AutoComplete>
        );
    }
}
